...
public class NotaController {
	...
	public List<NotaDto> listaFornecedores() {
		List<Nota> fornecedores = notaRepository.findAll();
		return NotaDto.converter(fornecedores);
	}
	...
	public NotaDto leitura(@PathVariable("id") Long id) {
		Nota fornecedor = notaRepository.getReferenceById(id);

		return new NotaDto(fornecedor);
	}
